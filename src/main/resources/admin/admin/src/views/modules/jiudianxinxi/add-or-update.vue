<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="酒店编号" prop="jiudianbianhao">
					<el-input v-model="ruleForm.jiudianbianhao" placeholder="酒店编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jiudianbianhao" label="酒店编号" prop="jiudianbianhao">
					<el-input v-model="ruleForm.jiudianbianhao" placeholder="酒店编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="酒店名称" prop="jiudianmingcheng">
					<el-input v-model="ruleForm.jiudianmingcheng" placeholder="酒店名称" clearable  :readonly="ro.jiudianmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="酒店名称" prop="jiudianmingcheng">
					<el-input v-model="ruleForm.jiudianmingcheng" placeholder="酒店名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="城市" prop="chengshi">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="城市" prop="chengshi">
					<el-input v-model="ruleForm.chengshi"
						placeholder="城市" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="酒店类别" prop="jiudianleibie">
					<el-select :disabled="ro.jiudianleibie" v-model="ruleForm.jiudianleibie" placeholder="请选择酒店类别" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="酒店类别" prop="jiudianleibie">
					<el-input v-model="ruleForm.jiudianleibie"
						placeholder="酒店类别" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="酒店星级" prop="jiudianxingji">
					<el-select :disabled="ro.jiudianxingji" v-model="ruleForm.jiudianxingji" placeholder="请选择酒店星级" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="酒店星级" prop="jiudianxingji">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="价格（天）" prop="jiage">
					<el-input v-model="ruleForm.jiage" placeholder="价格（天）" clearable  :readonly="ro.jiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="价格（天）" prop="jiage">
					<el-input v-model="ruleForm.jiage" placeholder="价格（天）" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="友情链接" prop="youqinglianjie">
					<el-input v-model="ruleForm.youqinglianjie" placeholder="友情链接" clearable  :readonly="ro.youqinglianjie"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="友情链接" prop="youqinglianjie">
					<el-input v-model="ruleForm.youqinglianjie" placeholder="友情链接" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="房间状态" prop="fangjianzhuangtai">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="房间状态" prop="fangjianzhuangtai">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="酒店地址" prop="jiudiandizhi">
					<el-input v-model="ruleForm.jiudiandizhi" placeholder="酒店地址" clearable  :readonly="ro.jiudiandizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="酒店地址" prop="jiudiandizhi">
					<el-input v-model="ruleForm.jiudiandizhi" placeholder="酒店地址" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="酒店介绍" prop="jiudianjieshao">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jiudianjieshao" label="酒店介绍" prop="jiudianjieshao">
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='youqinglianjie'){
							this.ruleForm.youqinglianjie = obj[o];
							this.ro.youqinglianjie = true;
							continue;
						}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jiudianjieshao = this.ruleForm.jiudianjieshao.replace(reg,'../../../springbootu1xmu/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
