...
<div :style='{"width":"1000px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"10px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="酒店编号" prop="jiudianbianhao">
              <el-input v-model="ruleForm.jiudianbianhao" placeholder="酒店编号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="酒店名称" prop="jiudianmingcheng">
            <el-input v-model="ruleForm.jiudianmingcheng" 
                placeholder="酒店名称" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}'  label="城市" prop="chengshi">
            <el-select v-model="ruleForm.chengshi" placeholder="请选择城市"  >
              <el-option
          ...
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}'  label="酒店类别" prop="jiudianleibie">
            <el-select v-model="ruleForm.jiudianleibie" placeholder="请选择酒店类别"  >
              <el-option
          ...
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}'  label="酒店星级" prop="jiudianxingji">
          ...
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}'  label="房间类型" prop="fangjianleixing">
          ...
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="数量" prop="shuliang">
            <el-input v-model="ruleForm.shuliang" 
                placeholder="数量" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="价格（天）" prop="jiage">
            <el-input v-model="ruleForm.jiage" 
                placeholder="价格（天）" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="友情链接" prop="youqinglianjie">
            <el-input v-model="ruleForm.youqinglianjie" 
                placeholder="友情链接" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}'  label="房间状态" prop="fangjianzhuangtai">
          ...
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="联系电话" prop="lianxidianhua">
            <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="酒店地址" prop="jiudiandizhi">
            <el-input v-model="ruleForm.jiudiandizhi" 
                placeholder="酒店地址" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="酒店介绍" prop="jiudianjieshao">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/chengshi/chengshi', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.chengshiOptions = res.data.data;
          }
        });
