...
public class JiudianxinxiController {
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        EntityWrapper<JiudianxinxiEntity> ew = new EntityWrapper<JiudianxinxiEntity>();
        List<Map<String, Object>> result = jiudianxinxiService.selectValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        EntityWrapper<JiudianxinxiEntity> ew = new EntityWrapper<JiudianxinxiEntity>();
        List<Map<String, Object>> result = jiudianxinxiService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
     ...
     * 分组统计
     */
    @RequestMapping("/typeStat/jiudianleibie/jiudianleibie")
    @IgnoreAuth
    public R jiudianleibiejiudianleibieTypeStat(HttpServletRequest request) {
        Map<String, Object> params = new HashMap<String, Object>();
        EntityWrapper<JiudianxinxiEntity> ew = new EntityWrapper<JiudianxinxiEntity>();
        List<Map<String, Object>> result = jiudianxinxiService.jiudianleibiejiudianleibieTypeStat(params, ew);
        return R.ok().put("data", result);
    }
