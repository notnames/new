...
public interface JiudianxinxiService extends IService<JiudianxinxiEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<JiudianxinxiEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<JiudianxinxiEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<JiudianxinxiEntity> wrapper);


    List<Map<String, Object>> jiudianleibiejiudianleibieTypeStat(Map<String, Object> params,Wrapper<JiudianxinxiEntity> wrapper);
