...
public class JiudianxinxiServiceImpl extends ServiceImpl<JiudianxinxiDao, JiudianxinxiEntity> implements JiudianxinxiService {
    ...
    @Override
    public List<Map<String, Object>> selectValue(Map<String, Object> params, Wrapper<JiudianxinxiEntity> wrapper) {
        return baseMapper.selectValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params, Wrapper<JiudianxinxiEntity> wrapper) {
        return baseMapper.selectTimeStatValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectGroup(Map<String, Object> params, Wrapper<JiudianxinxiEntity> wrapper) {
        return baseMapper.selectGroup(params, wrapper);
    }


    @Override
    public List<Map<String, Object>> jiudianleibiejiudianleibieTypeStat(Map<String, Object> params, Wrapper<JiudianxinxiEntity> wrapper) {
        return baseMapper.jiudianleibiejiudianleibieTypeStat(params, wrapper);
    }
