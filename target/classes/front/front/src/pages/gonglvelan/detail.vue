...
<div>
	...
	<div class="detail-preview" :style='{"minHeight":"1000px","width":"1000px","margin":"10px auto","position":"relative","height":"auto"}'>
		<div class="attr" :style='{"minHeight":"580px","padding":"20px","position":"relative","background":"#ebf0f4","display":"flex"}'>
			...
			<div class="zancai" :style='{"width":"150px","padding":"0","margin":"0","position":"absolute","top":"450px","left":"130px"}'>
				<div :style='{"border":"2px solid #fff","padding":"10px 0","margin":"10px 0","alignItems":"center","borderRadius":"20px","background":"#bfd2fc","display":"flex","width":"100%","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="zan" @click="thumbsupOrCrazily(21)">
				...
				<div :style='{"border":"2px solid #fff","padding":"10px 0","margin":"10px 0","alignItems":"center","borderRadius":"20px","background":"#bfd2fc","display":"flex","width":"100%","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="cai" @click="thumbsupOrCrazily(22)">
				...
				<div :style='{"border":"2px solid #fff","padding":"10px 0","margin":"10px 0","alignItems":"center","borderRadius":"20px","background":"#bfd2fc","display":"flex","width":"100%","justifyContent":"center"}' v-if="isThumbsupnum" class="zan" @click="cancelThumbsupOrCrazily(21)">
					<i :style='{"color":"#000","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-dianzan"></i>
					<span :style='{"color":"#000","margin":"0 3px","fontSize":"14px"}'>取消赞({{detail.thumbsupnum}})</span>
				</div>
				<div :style='{"border":"2px solid #fff","padding":"10px 0","margin":"10px 0","alignItems":"center","borderRadius":"20px","background":"#bfd2fc","display":"flex","width":"100%","justifyContent":"center"}' v-if="isCrazilynum" class="cai" @click="cancelThumbsupOrCrazily(22)">
					<i :style='{"color":"#000","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-iconfontzan"></i>
			...
			<div class="info" :style='{"width":"calc(100% - 400px)","padding":"10px","margin":"0 0 0 10px","background":"#e5e5e5"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#ebf0f4","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#000","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>攻略分类</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","height":"40px"}'>{{detail.gonglvefenlei}}</div>
				</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getStoreupStatus(){
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'gonglvelan', userid: localStorage.getItem('userid')}}).then(res => {
      ...
      thumbsupOrCrazily(type) {
        ...
        this.$http.post('gonglvelan/update', this.detail).then(res => {});
      },
    ...
    getThumbsupOrCrazilyStatus() {
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 21, refid: this.detail.id, tablename: 'gonglvelan', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
            ...
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 22, refid: this.detail.id, tablename: 'gonglvelan', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
